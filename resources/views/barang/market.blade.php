...
<head>
    <meta charset="UTF-8">
    <title>Daftar Barang Jualan</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        nav { /* ... sama seperti sebelumnya ... */ }
        /* Copy CSS dari barang/market agar konsisten */
        nav {
            display: flex;
            align-items: center;
        ...
        nav ul li a:hover,
        nav ul li button:hover { background-color: #FFE4C4; color: #FF7B00; }
        ...
        .filter-group select,
        .filter-group input { padding: 8px 12px; border: 2px solid #FF7B00; border-radius: 8px; outline: none; }
        ...
        .product-container { /* sama seperti sebelumnya */ display: flex; flex-wrap: wrap; gap: 20px; justify-content: center; padding: 20px; }
...
<div class="wrapper">
    <div class="container">
        ...
        <div class="filter-container">
            <form action="{{ route('barang.market') }}" method="GET">
                ...
                <div class="filter-group">
                    ...
                    <select name="kategori_barang" id="kategori_barang">
                        ...
                        <option value="{{ $kategori }}" {{ request('kategori_barang') == $kategori ? 'selected' : '' }}>{{ ucfirst($kategori) }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="filter-group">
                ...
                <a href="{{ route('barang.market') }}" class="btn-action btn-reset">Reset</a>
            </form>
        </div>
        ...
        <div class="product-container">
            ...
            >
                ...
                <img src="{{ asset('storage/uploads/barang/'.$item->foto1) }}" alt="{{ $item->nama_barang }}">
                @endif
...
<footer>&copy; {{ date('Y') }} CuanManis Barang. Semua Hak Dilindungi 🍊</footer>
